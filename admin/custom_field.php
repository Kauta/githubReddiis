...
<!-- /.Image icon modal -->
<!-- /.modal -->
<div id="modal_cf_icon_url" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <form name="cf_save_icon">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Edit Icon Url</h4>
                </div>
                <div class="modal-body">
                    <div class="loader" style="text-align: center;">
                        <img src="../loading.gif"/>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" id="saveEdit_CF_Icon">Save</button>
                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                </div>
            </form>
        </div>
                                    ...
                                    <div class="quickad-tbs-body">
                                        <div class="panel panel-default quickad-main">
                                            <div class="panel-body">
                                                <form name="cf_settings" action="ajax_sidepanel.php?action=SaveCustomFieldsSettings">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="quickad_custom_fields_per_service" id="quickad_custom_fields_per_service">
                                                                    <option <?php if(get_option("quickad_custom_fields_per_service") == '1'){ echo "selected"; } ?> value="1">Enabled</option>
                                                                    <option <?php if(get_option("quickad_custom_fields_per_service") == '0'){ echo "selected"; } ?> value="0">Disabled</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="cf_specific_fields">Show fields on List and Grid View</label>
                                                                <p class="help-block">When this setting is enabled your specific selected custom fields will be show on home and search page list or grid view.</p>

                                                                <select name="cf_specific_fields[]" id="cf_specific_fields" class="js-select2 form-control" multiple="multiple">
                                                                    <?php
                                                                    $cf_specific_fields = get_option("cf_specific_fields");
                                                                    $cf_specific_fields = explode(',',$cf_specific_fields);
                                                                    $cf_info = ORM::for_table($config['db']['pre'].'custom_fields')
                                                                        ->select_many('custom_id', 'custom_title')
                                                                        ->find_many();

                                                                    foreach ($cf_info as $value) {
                                                                        $id = $value['custom_id'];
                                                                        $title = $value['custom_title'];
                                                                        if(in_array($id,$cf_specific_fields) == -1){
                                                                            $selected = 'selected';
                                                                        }else{
                                                                            $selected = '';
                                                                        }
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 pull-right">
                                                            <button name="save_custom_fields_settings" type="submit" class="btn btn-primary btn-radius save-changes">Save</button>
                                                        </div>
                                                    </div>
                                                </form>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        <div class="input-group">
                                                                            <label class="input-group-addon cf_icon_modal">
