        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a href="setting.php#quickad_frontend_submission" class="btn btn-success waves-effect waves-light m-r-10">Post Listing setting</a>
                </div>
            </div>
                ...
                <div id="js-table-list">
                    <table class="js-table-checkable table table-vcenter table-hover" id="ajax_datatable" data-jsonfile="post.php?status=active">
                        ...
                        <tr>
                            ...
                            <th class="hidden-xs w-10" style="width:100px">Location</th>
