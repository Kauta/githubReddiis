            ...
            <div class="col-sm-12">
                ...
                <div class="white-box">
                    ...
                    <form name="form2"  class="form form-horizontal" method="post" data-ajax-action="editStaticPage" id="sidePanel_form">
                        <div class="form-body">
                            <input type="hidden" name="id" value="<?php echo escape_html($_GET['id'])?>">
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Slug:</label>
                                    <input name="slug" type="text" class="form-control" placeholder="Enter Page ID" value="<?php echo escape_html($info['slug'])?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Name:</label>
                                    <input name="name" type="text" class="form-control"  placeholder="Enter Page Title" value="<?php echo escape_html($info['name'])?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Title:</label>
                                    <input name="title" type="text" class="form-control"  placeholder="Enter Page Title" value="<?php echo escape_html($info['title'])?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Content:</label>
                                    <textarea name="content" rows="6" id="pageContent" class="form-control" placeholder="Enter Page Content"><?php echo escape_html($info['content'])?></textarea>
                                </div>
                            </div>
