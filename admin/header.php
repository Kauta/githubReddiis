        ...
        <aside class="app-layout-drawer">
            ...
            <div class="app-layout-drawer-scroll">
                ...
                <nav class="drawer-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav">
                            <a href="#"><i class="ion-image"></i> Listings</a>
                            <ul class="nav nav-subnav">
                                <li><a href="post_active.php">Active Listings</a></li>
                                <li><a href="post_pending.php">Pending Listings</a></li>
                                <li><a href="post_hidden.php">Hidden by user</a></li>
                                <li><a href="post_resubmit.php">Resubmited Listings</a></li>
                                <li><a href="post_expire.php">Expire Listings</a></li>
                                <li><a href="posts.php">All Listings List</a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-has-subnav">
                        ...
                        <li class="nav-item nav-item-has-subnav">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li><a href="setting.php#quickad_frontend_submission">Listing Post Setting</a></li>
                ...
                <div class="drawer-footer">
                    <p class="copyright"><a href="https://bylancer.com" target="_blank">Quickhomes By Bylancer</a> &copy;</p>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="header-navbar-collapse">
                        <ul id="main-menu" class="nav navbar-nav navbar-left">
                            ...
                            <li><a href="setting.php">Configuration</a></li>
                        </ul>
                        <!-- .navbar-left -->
