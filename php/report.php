...
{
	$_POST['email'] = htmlentities(escape_html($_POST['email']));
}

if(isset($_POST['name']))
{
	$_POST['name'] = htmlentities(escape_html($_POST['name']));
}

if(isset($_POST['type']))
{
	$_POST['type'] = htmlentities(escape_html($_POST['type']));
}

if(isset($_POST['username']))
{
	$_POST['username'] = htmlentities(escape_html($_POST['username']));
}

if(isset($_POST['username2']))
{
	$_POST['username2'] = htmlentities(escape_html($_POST['username2']));
}

if(isset($_POST['details']))
{
	$_POST['details'] = htmlentities(escape_html($_POST['details']));
}

if(isset($_POST['url']))
{
	$_POST['url'] = htmlentities(escape_html($_POST['url']));
}

if(isset($_POST['violation']))
{
	$_POST['violation'] = htmlentities(escape_html($_POST['violation']));
}
...
else
{
	...
	if($errors)
	{
		...
		$page->SetParameter ('USERNAME', escape_html($_POST['username']));
		$page->SetParameter ('USERNAME2', escape_html($_POST['username2']));
		$page->SetParameter ('NAME', escape_html($_POST['name']));
		$page->SetParameter ('EMAIL', escape_html($_POST['email']));
		$page->SetParameter ('DETAILS', escape_html($_POST['details']));
