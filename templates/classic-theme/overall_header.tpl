...
<head>
    ...
    <script src="{SITE_URL}templates/{TPL_NAME}/js/main.js"></script>
                ...
                <div class="left-side">
                    ...
                    <nav class="mmenu-init">
                        <ul class="mm-listview">
                            ...
                            {:IF}
                            <li><a href="{LINK_POST-AD}" class="button ripple-effect">{LANG_POST_ADVERTISE}</a></li>
                    ...
                    <div class="header-widget d-none d-lg-block">
                        <nav class="navigation">
                            <ul>
                                ...
                                <li><a href="{LINK_SIGNUP}">{LANG_REGISTER}</a></li>
                                {:IF}
                                <li><a href="{LINK_POST-AD}" class="button ripple-effect post-job">{LANG_POST_ADVERTISE}</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
